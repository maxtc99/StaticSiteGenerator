...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_images(self):
        matches = extract_markdown_images(
            "This is text with an image ![python logo](https://i.imgur.com/zjjcJKZ.png)"
        )
        self.assertListEqual(
            [
                ("python logo", "https://i.imgur.com/zjjcJKZ.png")
            ],
            matches,
        )
    ...
    def test_extract_markdown_images_2(self):
        matches = extract_markdown_images(
            '''
            This is text with two images ![python logo](https://i.imgur.com/zjjcJKZ.png)
            and ![python logo 2](https://www.python.org/static/community_logos/python-powered-w-200x80.png)
            '''
        )
        self.assertListEqual(
            [
                ("python logo", "https://i.imgur.com/zjjcJKZ.png"),
                ("python logo 2" ,"https://www.python.org/static/community_logos/python-powered-w-200x80.png")
            ], 
            matches,
        )
    ...
    def test_extract_markdown_links_2(self):
        matches = extract_markdown_links(
            '''
            This is a text with two links [to google](https://www.google.com)
